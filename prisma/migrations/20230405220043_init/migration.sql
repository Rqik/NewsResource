...
-- CreateTable
CREATE TABLE "drafts" (
    "draft_id" INTEGER GENERATED ALWAYS AS IDENTITY NOT NULL,
    "created_at" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "posts" (
    ...
    "fk_category_id" INTEGER,
    "updated_at" TIMESTAMPTZ(6),
    "is_publicate" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "tokens" ADD CONSTRAINT "fk_tokens_user_id" FOREIGN KEY ("fk_user_id") REFERENCES "users"("user_id") ON DELETE SET NULL ON UPDATE CASCADE;
